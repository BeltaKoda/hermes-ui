...
export const en: Translations = {
  ...
  zones: {
    ...
    desktopEditHint: 'Show or hide desktop workspace panes.',
    mobileEditHint: 'Pick a layout for this phone. Swipe in from either edge for menus; desktop stays unchanged.',
    panes: 'Panes',
    filesPane: 'Files',
    mobileDefault: 'Default',
    mobileDefaultDescription: 'Show auxiliary panes when they are open.',
    mobileFocus: 'Focus',
    mobileFocusDescription: 'Keep chat full-width and suppress auxiliary docked panes.',
    reset: 'Reset',
    templates: 'Templates',
    custom: 'Custom',
