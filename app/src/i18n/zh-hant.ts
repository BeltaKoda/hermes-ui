...
export const zhHant = defineLocale({
  ...
  zones: {
    ...
    desktopEditHint: '顯示或隱藏桌面工作區面板。',
    mobileEditHint: '為此手機選擇版面。從任一側邊向內滑動可開啟選單；桌面配置不會改變。',
    panes: '面板',
    filesPane: '檔案',
    mobileDefault: '預設',
    mobileDefaultDescription: '開啟輔助面板時顯示它們。',
    mobileFocus: '專注',
    mobileFocusDescription: '讓聊天保持全寬並隱藏停駐的輔助面板。',
    reset: '重設',
    templates: '範本',
    custom: '自訂',
